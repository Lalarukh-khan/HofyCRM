...
<?php
  ...
  $all_companies = mysqli_query($con,$sql);
?>
<?php
include("header.php"); 
?>
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="allemployees.php">Registered</a></li>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="POST" action="registeremployee.php">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="emp_phone" required/>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <select name="emp_company" class="form-control">
                                    <?php 
                                        // use a while loop to fetch data 
                                        // from the $all_companies variable 
                                        // and individually display as an option
                                        while ($category = mysqli_fetch_array(
                                                $all_companies,MYSQLI_ASSOC)):; 
                                    ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <select class="form-control"  name="emp_country" required>
                      ...
                      <button type="submit" class="btn btn-primary mr-2" name="reg_employee">Submit</button>
                      </div>
                    </form>
                  </div>
                </div>
