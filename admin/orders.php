            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <h4 class="card-title">All Orders</h4>
                    <p class="card-description"> More Details <code><a href="ordersrequest.php" style="text-decoration: none;
                    border: 1px solid grey; padding: 8px 4px; color: #fc424a;">All Order's Requests</a></code>
                    </p>
                    <br>
                    <br>
                <h3>Accepted Order's</h3>
                <?php
...
<?php if(isset($_SESSION['success'])){
	...
	?>
                      <div class="table-responsive">    
                        ...
                        $query="SELECT * FROM order_requests WHERE status='Approved'";
                            $res=mysqli_query($conn, $query);
